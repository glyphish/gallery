...
- (void) imageBrowser:(IKImageBrowserView *)browser cellWasRightClickedAtIndex:(NSUInteger) index withEvent:(NSEvent *) event
{
    ...
    [menu addItemWithTitle:[NSString stringWithFormat:@"Copy"] action:nil keyEquivalent:@""];
    [menu addItemWithTitle:[NSString stringWithFormat:@"Reveal in Finder"] action:nil keyEquivalent:@""];
